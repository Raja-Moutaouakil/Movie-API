...
# Turn DEBUG off for reviewer-facing pages so Django shows standard error pages
# Set to False for review/demo; set to True or use env var for local development as needed.
DEBUG = False
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for creating and viewing movie reviews',
    'VERSION': '1.0.0',
}
